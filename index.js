                ...
                <div class="movie">
                    ...
                    <div class="movie-text-container"> 
                        ...
                        <div class="movie-info">
                            ...
                            <button id="watchlist-btn" class="watchlist-btn" data-id="${movie.imdbID}" ${isInWatchlist ? 'disabled' : ''}>
    ...
    async function handleSubmit(e) {
        ...
        if (movieTitle) {
            ...
            if (movies) {
                ...
                watchlistBtns.forEach(btn => btn.addEventListener("click", addToWatchlist))
            } else {
                main.innerHTML = `
